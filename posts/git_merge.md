...
3. "Files changed"に書かれた変更点に問題がなければ、"Merge pull request"と書かれたボタンを押し、ページ遷移後さらに"Confirm merge"と書かれたボタンを押します。なお、"Files changed"に問題があれば、コメントを返すこともできます。![マージサンプル3](https://i.imgur.com/pluAR7E.png)